...
const socialLinks = [
    {
        href: 'https://www.github.com/abhiguptanitb',
    ...
    {
        href: 'https://www.linkedin.com/in/abhiguptanitb',
        icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    // },
    // {
    //     href: 'https://www.instagram.com/guptaabhi08',
    ...
    return (
        <section id="contact" className="section">
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                ...
                <form action="https://getform.io/f/amdpvkeb" method="POST" className="xl:pl-10 2xl:pl-20">
                    ...
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        <div className="mb-4">
                            ...
                            <input type="text" name="name" id="name" autoComplete="name" required placeholder="Abhi Gupta" className="text-field reveal-up" />
                        </div>
                        ...
                        <div className="mb-4">
                            ...
                            <input type="email" name="email" id="email" autoComplete="email" required placeholder="abhi@example.com" className="text-field reveal-up" />
                        </div>
